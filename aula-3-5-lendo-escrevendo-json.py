...
# dado_desconvertido = json.dumps(dado_convertido, ensure_ascii = False, indent = 4)
# print(type(dado_convertido))
...
with open(pasta_atual / 'jsons' / 'assinantes.json') as arquivo:
    dado_carregado = json.load(arquivo)
...
with open(pasta_atual / 'jsons' / 'assinantes_copia.json', 'w') as arquivo:
    json.dump(dado_carregado, arquivo, indent = 3, ensure_ascii = False)
